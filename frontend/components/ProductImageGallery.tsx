    ...
    <div className="space-y-4">
      ...
      >
        ...
        {hasRealImages ? (
          ...
          <div
            ref={placeholderRef}
            className={`absolute inset-0 bg-gradient-to-br ${gradient} transform-origin-center flex items-center justify-center transition-transform duration-500 ease-out will-change-transform group-hover:scale-[1.08]`}
          >
