...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] dark:bg-[#0D1015] text-[#1D1D1F] dark:text-[#F5F5F7] pb-[76px] lg:pb-8 transition-colors duration-200">
      ...
      <div className="mx-auto grid max-w-[1440px] grid-cols-1 gap-6 px-3 py-5 sm:px-5 lg:grid-cols-[250px_1fr]">
        {/* ── SIDEBAR NAV (macOS / iPadOS Glassmorphic Sidebar) — desktop only ── */}
        <aside className="hidden h-fit rounded-2xl apple-glass p-3 shadow-sm lg:sticky lg:top-20 lg:block">
          <div className="px-3 py-2.5 mb-1.5 border-b border-black/[0.06] dark:border-white/[0.08]">
            <p className="text-[10.5px] font-bold uppercase tracking-widest text-black/40 dark:text-white/40">Workspace</p>
            <p className="mt-0.5 text-sm font-bold tracking-tight text-[#0F172A] dark:text-white">Management Center</p>
          </div>
            ...
            {tabs.map(tab => {
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-[13px] font-medium transition-all duration-150 active:scale-[0.98] ${
                    isActive
                      ? 'bg-black text-white dark:bg-white dark:text-black font-semibold shadow-sm'
                      : 'text-black/70 dark:text-white/70 hover:bg-black/[0.05] dark:hover:bg-white/[0.08] hover:text-black dark:hover:text-white'
                  }`}
                >
                  <tab.icon className={`h-4 w-4 ${isActive ? 'text-white dark:text-black' : 'text-black/50 dark:text-white/50'}`} />
                  <span>{tab.label}</span>
...
function RevenueTrendVisualizer({
  ...
  // Synthesize a realistic 7-point trend progression reflecting actual telemetry
...
function OrdersDistributionVisualizer({
  ...
  return (
    <div className="mt-3 pt-2">
      ...
      {/* Multi-segment Apple Progress Bar */}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
        ...
        <div className="lg:col-span-5 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {/* Sub-Card 4: Average Order Value (AOV) */}
            <div className="apple-subcard p-4">
              <div className="flex items-center justify-between mb-2">
        ...
        <div className="lg:col-span-4 space-y-3">
          ...
          <div className="apple-card p-5 border-blue-500/20 dark:border-blue-500/30">
            ...
            {/* Orders Fulfillment Distribution Visualizer */}
          ...
          <div className="grid grid-cols-2 gap-3">
            {/* Sub-Card 1: Pending Orders (Action Alert) */}
            <div
              onClick={() => onNavigate('orders')}
            ...
            {/* Sub-Card 4: Delivered / Completed */}
            <div className="apple-subcard p-4">
              <div className="flex items-center justify-between mb-2">
                <div className="apple-squircle-badge !w-7 !h-7 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400">
                  <FiCheck className="w-3.5 h-3.5" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        {/* Real-time Store Activity Timeline */}
        <div className="apple-card p-5">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <div className="apple-squircle-badge !w-6 !h-6 bg-blue-500/10 text-blue-600 dark:text-blue-400">
